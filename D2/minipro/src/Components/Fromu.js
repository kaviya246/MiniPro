...
// if (!fields["country"]) { formIsValid = false;
...
if (typeof fields["mobileno"] !== "undefined") { if (!fields["mobileno"].match(/^[0-9]{10}$/)) {
    ...
    <input type="text" name="username" placeholder='First_Name' value={this.state.fields.username}
    onChange={this.handleChange} />
    <div className="errorMsg">{this.state.errors.username}</div>
    <label>Last_Name:</label>
    <input type="text" name="name" placeholder='Last_Name' value={this.state.fields.name}
    onChange={this.handleChange} />
    <div className="errorMsg">{this.state.errors.name}</div>
     <lable>Email_Id:</lable>
     <input type="text" name="emailid"placeholder=' Email_Id' value={this.state.fields.emailid}
     onChange={this.handleChange}/>
     <div className="errorMsg">{this.state.errors.emailid}</div>
    <label>Mobile No:</label>
    <input type="text" name="mobileno" placeholder=' Mobile_No' value={this.state.fields.mobileno}
    onChange={this.handleChange} />
    <div className="errorMsg">{this.state.errors.mobileno}</div>
    <label>Age:</label>
    <input type="text" name="age" placeholder=' Age' value={this.state.fields.age}
    onChange={this.handleChange}/>
    <div className="errorMsg">{this.state.errors.age}</div>
    <label>Salary</label>
    <input type="text" name="salary" placeholder=' Salary' value={this.state.fields.salary}
    onChange={this.handleChange}/>
    ...
    <input type="Confirm" name="Confirm" placeholder='Confirm Password' value={this.state.fields.Confirm}
    onChange={this.handleChange} />
    <div className="errorMsg">{this.state.errors.password}</div>
